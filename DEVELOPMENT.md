...
See [docs/SYNCING_BOILERPLATE.md](docs/SYNCING_BOILERPLATE.md). Interpret hierarchy at **this** tier (`cookiecutter-rails`, Rails) using the `template-hierarchy` skill when present.
